...
def _main():
    ...
    dm = ml_db.IARA(
            ...
            cv = ml_cv.FiveByTwo(),
            #DC.A e um subconjunto do IARA
            data_collection = ml_iara.DC.A,
            #define o problema de classificacao e retorna um selection
    ...
    trainer = lightning.Trainer(
        ...
        accelerator="auto",
        # reducao de batches para treinamento mais rapido a fim de debugar o codigo
